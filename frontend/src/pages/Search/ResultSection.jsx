                    ...
                    <div className="left__box w-3/4 h-full flex flex-col justify-evenly items-start">
                        ...
                        <div className="w-4/5 flex flex-col justify-center items-start gap-4">
                            <div className="wrapper">
                                ...
                                <p className="pl-2">{data?.description || "demo"}</p>
                            </div>
                            <div className="wrapper">
                                <div className="heading text-[1.8rem]  font-medium">Properties</div>
                                <p className="pl-2">{data?.properties || "demo2"}</p>
                            </div>
                            <div className="wrapper">
                                <div className="heading text-[1.8rem]  font-medium">Helps in</div>
                                <p  className="pl-2">Respiratory ailments, fever, cold, cough, stress, anxiety, inflammation, and digestive issues.</p>
                            </div>
                            <div className="wrapper">
                                <div className="heading text-[1.8rem]  font-medium">Benefits</div>
                                <p className="pl-2">Boosts immunity, improves respiratory health, reduces stress, promotes relaxation, supports healthy digestion, and has antibacterial and antiviral properties.</p>
                            </div>
                        </div>
                    </div>

                    <div className="right__box w-2/10 relative h-full flex justify-center items-center ">
                    <div className="image_box w-full h-4/5 rounded-[2rem] bg-primary-100 overflow-hidden">
                        <img
                            src={photoURL || Images.plant1}
                            alt="plant image"
