...
import { medicineSuggesion, selectCurrentMedicine } from "../../utils/medicineSlice";
...
const MedicineSection = () => {
    const { data, problem, status, error} =
        useSelector(selectCurrentMedicine);
    console.log(data, problem, status, error);
            ...
            <div className="wrapper mt-[80px] h-full w-full">
                <div className="mx-24 ">
                    <div className="left__box w-3/4 h-full flex flex-col justify-evenly items-start">
                        ...
                        {data.remedies.map((data)=>(<div className="w-4/5 flex flex-col justify-center items-start gap-4">
                            ...
                            <div className="wrapper">
                                <div className="heading text-[1.2rem] font-medium">
                                    Properties
                                </div>
                                <p className="pl-2">
                                    {status === "loading" ? (
